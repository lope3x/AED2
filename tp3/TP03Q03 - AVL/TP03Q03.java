	...
	private No balancear(No i){
		if(i!=null){
			...
			//desbalanceada para direita
				...
				int fatorpai = getAltura(i.dir.dir) - getAltura(i.dir.esq);
				if(fatorpai == -1){
			...
			//desbalanceada para esquerda fator = -2
				...
				int fatorpai = getAltura(i.esq.dir) - getAltura(i.esq.esq);
				if(fatorpai == 1){
					//rotacao dupla para dir
...
class No{
	...
	No(Presidente x,No esq, No dir,int nivel){
		this.esq=esq;
		this.dir=dir;
		elemento=x;
		this.nivel=nivel;
