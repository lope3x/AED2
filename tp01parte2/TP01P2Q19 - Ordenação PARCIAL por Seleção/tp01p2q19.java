...
public class tp01p2q19{
	...
	public static void entrada()throws Exception{
		...
		presidentes.ordenacaoSelecaoParcial();
...
class Lista{
	...
	*/
	...
	/**
	 * Ordena o array com o algoritmo de ordenacao
	 */
	...
	/**
	 * Ordena o array com o algoritmo de selecao parcial com k valendo 10
	 */
	public void ordenacaoSelecaoParcial(){
		int menor;
		for(int i=0;i<10;i++){
			menor=i;
			for(int j=(i+1);j<n;j++){
