...
class Lista{
	...
	*/
	...
	/**
	 * O metodo realiza a ordenacao do array pelo algoritmo da bolha 
	 */
	 public void bolha() {
        for (int i = (n - 1); i > 0; i--) {
            for (int j = 0; j < i; j++) {
   ...
   /**
    * O metodo realiza a ordenacao do array pelo metodo mergesort
	*/
	...
	/**
	 * O metodo realiza a juncao dos dois vetores os ordenando no proceso
	 * @param int inicio indicando o comeco do vetor
	 * @param int meio indicanco a metade do vetor
	 * @param int fim indicando o final do vetor 
	 */
	public void merge(int inicio, int meio, int fim){
		int tamanho=(fim-inicio)+1;
		Presidente[] temp = new Presidente[tamanho];
		...
		for(int i=0;i<tamanho;i++){
			if(!fim1&&!fim2){
				comparacao++;
				if(array[p1].getFimMandato().isBefore(array[p2].getFimMandato())){
					movimentacoes++;
					temp[i]=array[p1++];
				}
				else{
