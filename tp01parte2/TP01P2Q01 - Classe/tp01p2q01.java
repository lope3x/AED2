...
public class tp01p2q01{
	...
	public static void entrada()throws Exception{
		...
		do{
			...
			teste.printPresidente(teste);
			input=MyIO.readLine();
			if(!input.equals("FIM "))input=ISO88591toUTF8(input);
...
class Presidente implements Cloneable{
   ...
   public void lePresidente(String nomeArquivo){
	...
	public void printPresidente(Presidente teste){
		...
		String datamorte="";
		if(dataMorte!=null)datamorte = teste.getDataMorte().format(formatter);
		if(dataMorte==null)MyIO.println(teste.getId()+" ## "+teste.getNome()+" ## "+iniciomandato+" (I) ## "+fimmandato+" (F) ## "+nascimento+" em "+teste.getLocalNascimento()+" (N) ## "
